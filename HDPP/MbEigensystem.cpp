 ...
 */
MbEigensystem::MbEigensystem(const MbMatrix<double> &m) : n(0), isComplex(false) {
 ...
 */
void MbEigensystem::balance(MbMatrix<double> &a, std::vector<double> &scale, int *low, int *high) {
 ...
 */
void MbEigensystem::complexLUBackSubstitution(MbMatrix<mbcompl> &a, int *indx, std::vector<mbcompl> &b) {
 ...
 */
void MbEigensystem::elmhes(int low, int high, MbMatrix<double> &a, std::vector<int> &perm) {
 ...
 */
void MbEigensystem::elmtrans(int low, int high, MbMatrix<double> &a, std::vector<int> &perm, MbMatrix<double> &h) {
 ...
 */
int MbEigensystem::hqr2(int low, int high, MbMatrix<double> &h, std::vector<double> &wr, std::vector<double> &wi, MbMatrix<double> &eivec) {	
